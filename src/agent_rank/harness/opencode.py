...
from agent_rank.metrics import parse_opencode_metrics, calculate_tps
...
class OpencodeHarness(BaseHarness):
    ...
    def run(
        ...
        ttft, decode_window, win_source, in_toks, out_toks, used_tools = parse_opencode_metrics(lines)
